...
class NormalTestJbgBrGetGuessPrompt(TestJbgBrGetGuessPrompt):
    ...
    def test_n01_round_1_guess_1a(self):
        ...
        self.expect_return("The player Magugol is giving clues about the name of a well-known "
                           "story which could be a book, a movie, etc. "
                           "It's a story about a dull good guy. "
                           "Answer the following in one or two words without adding "
                           "adjectives or adverbs... What story is magugol describing?")
        self.run_test()
    ...
    def test_n05_round_1_guess_2a(self):
        ...
        self.expect_return("The player Mumu is giving clues about a specific, well-known "
                           "place, real or fictional, that exists in media or the real world. "
                           "It's a vibrant place. "
                           "Answer the following in one or two words without adding adjectives "
                           "or adverbs... What place is mumu describing?")
        self.run_test()
    ...
    def test_n10_round_2_guess_4b(self):
        ...
        self.expect_return("The player Mumu is giving clues about a specific unique person "
                           "who could be fictional, real, pop-culture icon, alien, etc. "
                           "They're a fictional  entity. They are renowned for the patience. "
                           "Answer the following in one or two words without adding "
                           "adjectives or adverbs... What person is mumu describing?")
        self.run_test()

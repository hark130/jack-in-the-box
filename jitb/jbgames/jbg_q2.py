...
from jitb.jitb_webdriver import (get_prompt, get_char_limit_attr, get_vote_text, is_prompt_page,
                                 is_vote_page, vote_answers)
...
class JbgQ2(JbgAbc):
    ...
    def _answer_last_lash(self, web_driver: selenium.webdriver.chrome.webdriver.WebDriver) -> None:
        ...
        gen_answer = self.generate_ai_answer(prompt_text, ai_obj=self._ai_obj)
...
# def is_last_lash_page(web_driver: selenium.webdriver.chrome.webdriver.WebDriver) -> bool:
#     """Determine if this is the Round 3 Last Lash prompt page.
